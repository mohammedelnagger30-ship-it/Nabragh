...
import { GraduationCap, Facebook, Youtube, Instagram, Mail, Phone, MapPin, MessageCircle, X } from 'lucide-react';
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-2 gap-x-5 gap-y-8 sm:gap-x-8 md:grid-cols-4 md:gap-10">
          <div className="md:col-span-1">
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="text-base font-bold text-white sm:text-xl">منصة العلم</span>
            </div>
          ...
          <div>
            <h3 className="mb-3 text-sm font-semibold text-white sm:mb-4 sm:text-base">تواصل معنا</h3>
            <ul className="space-y-2 text-xs sm:space-y-3 sm:text-sm">
      ...
      {showSupportButton && <div className="fixed bottom-20 left-4 z-40 sm:bottom-6 sm:left-6">
        <a href={whatsappLink()} target="_blank" rel="noreferrer" aria-label="واتساب الدعم" title="واتساب الدعم" className="flex h-12 w-12 items-center justify-center rounded-full bg-[#128C7E] text-white shadow-xl shadow-[#075E54]/30 ring-4 ring-white/80 transition-all hover:-translate-y-1 hover:bg-[#075E54] hover:shadow-2xl dark:ring-slate-950/80 sm:h-14 sm:w-14">
