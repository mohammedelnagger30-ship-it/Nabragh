...
export default function CompetitionsPage() {
  ...
  return <div className="min-h-screen bg-slate-50 pb-16 pt-28"><MetaTags title="المنافسات التعليمية | منصة العلم" description="نافس الطلاب في تحديات تعليمية، اجمع النقاط، وارتقِ في الترتيب" /><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
