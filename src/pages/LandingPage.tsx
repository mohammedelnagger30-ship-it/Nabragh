    ...
    <div className="pt-16">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/40">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-10 -left-20 w-96 h-96 bg-cyan-200/20 rounded-full blur-3xl" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-right">
              <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-6 border border-blue-100">
                ...
                منصة تعليمية احترافية عالمية المستوى
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-800 leading-tight mb-6">
                تعلّم من أفضل
                <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent"> المدرسين </span>
                في العالم العربي
              </h1>
              <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-xl mx-auto lg:mr-0">
                منصة تعليمية متكاملة تتيح للمدرسين رفع فيديوهاتهم الشرحية بجودة عالية وحماية كاملة،
                وللطلاب الوصول إلى محتوى تعليمي متميز في جميع التخصصات.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link
                  to="/signup"
                  className="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                >
                  ابدأ التعلم الآن
                ...
                <Link
                  to="/teachers"
                  className="px-8 py-3.5 bg-white text-slate-700 font-semibold rounded-xl border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
                >
                  تصفح المدرسين
              ...
              <form onSubmit={(e) => { e.preventDefault(); if (searchQuery.trim()) navigate(`/search?q=${encodeURIComponent(searchQuery)}`); }}
                className="mt-8 relative max-w-xl mx-auto lg:mr-0">
                ...
                <input
                  ...
                  className="w-full pr-12 pl-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors shadow-sm"
                />
              </form>
            </div>
              ...
              <div className="relative z-10 grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 p-6 border border-slate-100">
                    ...
                    <h3 className="font-bold text-slate-800 mb-1">فيديوهات HD</h3>
                    <p className="text-sm text-slate-500">جودة عالية مع حماية كاملة للمحتوى</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl shadow-xl shadow-blue-500/30 p-6 text-white">
                    <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center mb-3">
                      <Shield className="w-6 h-6" />
                    </div>
                    <h3 className="font-bold mb-1">حماية كاملة</h3>
                    <p className="text-sm text-blue-50">حماية الفيديوهات والبيانات بأعلى المعايير</p>
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 p-6 border border-slate-100">
                    ...
                    <p className="text-sm text-slate-500">نخبة من أفضل المدرسين في كل تخصص</p>
                  </div>
                  <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 p-6 border border-slate-100">
                    ...
                    <p className="text-sm text-slate-500">تابع تقدمك في كل مادة وكل درس</p>
                  </div>
                </div>
              </div>
            </div>
