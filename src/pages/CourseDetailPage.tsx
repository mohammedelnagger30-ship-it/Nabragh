        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              {course.description && <p className="mb-4 text-lg leading-relaxed text-slate-300 dark:text-slate-600">{course.description}</p>}
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              {enrollment ? (
                ...
                <div>
                  <p className="text-slate-300 dark:text-slate-600 text-sm mb-4">سجل في هذه الدورة للوصول الكامل لجميع الدروس وتتبع تقدمك</p>
                  ...
                  {!user && <p className="text-xs text-slate-400 dark:text-slate-500 text-center mt-3"><Link to="/signin" className="text-blue-400 hover:underline">تسجيل الدخول</Link> أو <Link to="/signup" className="text-blue-400 hover:underline">إنشاء حساب</Link></p>}
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 sticky top-20">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700">
                  <span className="text-slate-500 dark:text-slate-400">المستوى</span>
                  <span className="font-bold text-slate-800 dark:text-slate-100">{levelLabels[course.level]}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700">
                ...
                <div className="flex items-center justify-between py-2">
                  ...
                  <span className="font-bold text-slate-800 dark:text-slate-100">{course.price === 0 ? 'مجاني' : `${course.price} ر.س`}</span>
                </div>
              </div>
              {course.teacher && (
